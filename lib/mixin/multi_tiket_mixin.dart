...
mixin GetMultipleTickerProviderMixin implements TickerProvider {
  Set<Ticker>? _tickers;
...
class _Ticker extends Ticker {
  _Ticker(super.onTick, this._creator, {super.debugLabel});

  final GetMultipleTickerProviderMixin _creator;
